// src/pages/CatgTelaAdmin/AgregarCatgTela.jsx
import React, { useState } from "react";
import { useNavigate } from "react-router-dom";

export default function AgregarCatgTela() {
  ...
  const handleSubmit = async e => {
    ...
    const res = await fetch("http://localhost:5000/catg_tela/add", {
      method: "POST",
  ...
  return (
    <div className="min-h-screen bg-white px-6 py-8 flex flex-col">
      <h1 className="text-4xl font-bold mb-2">Agregar Categoría de Tela</h1>
      ...
      <form className="max-w-3xl mx-auto flex flex-col gap-6" onSubmit={handleSubmit}>
        ...
        <div className="bg-[#f7f7f7] rounded-xl shadow px-6 py-4">
          ...
          <textarea
            ...
            placeholder="Ej: Telas a base de algodón, transpirables"
          />
        </div>
