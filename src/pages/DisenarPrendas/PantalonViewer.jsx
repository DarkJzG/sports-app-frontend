// src/pages/DisenarPrendas/PantalonViewer.jsx
...
export default function PantalonViewer() {
  ...
  const [productId, setProductId] = useState("pantalon");
  ...
  const handleGuardarDiseno = async () => {
    ...
    try {
      ...
      for (const a of angles) {
        camera.position.set(Math.sin(a.rotationY) * 5, 0, Math.cos(a.rotationY) * 5);
      ...
      formData.append("categoria", productId || "pantalon");
      formData.append("modelo", `PA-${Date.now()}`);
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex-1 bg-white rounded-lg shadow-lg relative">
          <PantallaCarga
            ...
            message={
              loadingLogo ? "Subiendo logo a Cloudinary..." : "Guardando tu diseño 3D..."
            }
          />
          <Canvas
            dpr={dpr}
